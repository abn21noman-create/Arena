...
const EXACT_ROUTE_LABELS: Record<string, string> = {
  ...
  "/learn/photosynthesis-lab": "সালোকসংশ্লেষণ ও শ্বসন ল্যাব",
  ...
  "/lab/doppler-sound": "ডপলার ক্রিয়া ল্যাব",
  "/lab/electrochemistry": "তড়িৎ রসায়ন ও নার্নস্ট সেল ল্যাব",
  "/lab/complex-plane": "জটিল সংখ্যা আরগ্যান্ড স্টুডিও",
  "/badges": "ব্যাজ",
